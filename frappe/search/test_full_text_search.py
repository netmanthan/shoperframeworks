...
def get_documents():
	...
	docs.append(
		{
			...
			ShoperPrime Solutions and is built on MariaDB database system using a Python based server-side framework.
	...
	docs.append(
		{
			"name": "sw/frappe",
			"content": """NETMANTHAN is a full-stack web framework, that includes everything you need to build and
