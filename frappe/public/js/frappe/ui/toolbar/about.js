...
frappe.ui.misc.about = function () {
	if (!frappe.ui.misc.about_dialog) {
		var d = new frappe.ui.Dialog({ title: __("NETMANTHAN") });
		...
		<p><i class='fa fa-facebook fa-fw'></i>\
			Facebook: <a href='https://facebook.com/shoperprimeHO' target='_blank'>https://facebook.com/shoperprimeHO</a></p>\
		<p><i class='fa fa-twitter fa-fw'></i>\
			Twitter: <a href='https://twitter.com/shoperprimeHO' target='_blank'>https://twitter.com/shoperprimeHO</a></p>\
		<hr>\
		<h4>Installed Apps</h4>\
		<div id='about-app-versions'>Loading versions...</div>\
		<hr>\
		<p class='text-muted'>&copy; NETMANTHAN and Contributors </p> \
		</div>",
				frappe.app
			)
		);
